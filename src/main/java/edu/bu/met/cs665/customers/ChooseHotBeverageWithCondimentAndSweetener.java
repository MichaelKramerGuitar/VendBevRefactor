 ...
 */
public class ChooseHotBeverageWithCondimentAndSweetener implements Choice {

  private Customer customer;
  private HotBeverage beverage;

  public ChooseHotBeverageWithCondimentAndSweetener(Customer customer, HotBeverage beverage) {
   ...
   * choosing a Beverage and size with both condiment and sweetener.
   */
  @Override
